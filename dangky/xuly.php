...
{
echo '<script language="javascript">alert("Tên đã được xử dụng, vui lòng nhập tên khác"); window.location="register.php";</script>';
...
echo '<script language="javascript">alert("Đăng ký thành công!"); window.location="http://localhost/web/dangnhap/login.php";</script>';
